...
PImage img2, img3, img4, img5, img6, img7, img8, img9;
PImage bg;
...
void setup() {
  ...
  img3 = loadImage("finca.jpg");
  img4 = loadImage("institutriz.png");
  img5 = loadImage("niños.png");
  img7 = loadImage("fantasma1.png");
  img8 = loadImage("fantasma2.png");
...
//pantalla 2
   ...
   image(img3,40,yTextoPantalla1 - 20,270,510);
...
image(img4,xImagenPantalla2,80,270,350);
...
//pantalla 4
   ...
   image(img5,70,yImagenPantalla3,500,220);
...
image(img7, 40, 40, 180, 160);
image(img8, 40, 240, 180, 160);
